    ...
    return (
        <View
            ...
            <Text style={{ ...FONTS.body1, color: COLORS.textTitle }}>
                { isAccountRecovery == true  ? t('troubleLogin:accountRecovery') : t('checkYourEmail:checkYourEmail')}
            </Text>
        </View>
    );
}
...
function renderForm() {
    ...
    <Text style={{ ...FONTS.body2, color: COLORS.displayText,textAlign:'center' }}>
        {isAccountRecovery == true ? t('troubleLogin:accRecoveryInfo') : 
        ...
        <View
            ...
            <TouchableOpacity
                ...
                <Text
                    ...
                    { isAccountRecovery == true ? t('troubleLogin:signInWithEmail') :t('checkYourEmail:OK') }
                </Text>
            </TouchableOpacity>
        </View>
    );
